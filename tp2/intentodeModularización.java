...
public class SistemaCNE {   
    ...
    public class Distrito{
        ...
        public Distrito(String[] nombresDistritos, int[] diputadosPorDistritos,
                    int[] rangoMesasDistritosInf, int[] rangoMesasDistritosSup,
                    int[] totalVotosDist, boolean[] calcDip) {
        this.nombresDistritos = nombresDistritos;
        this.diputadosPorDistritos = diputadosPorDistritos;
        this.rangoMesasDistritosInf = rangoMesasDistritosInf;
        this.rangoMesasDistritosSup = rangoMesasDistritosSup;
        this.totalVotosDist = totalVotosDist;
        this.calcDip = calcDip;
    ...
    public class Partido{
        ...
        public Partido(String[] nombresPartidos, int cantidadDeDistritos) {
        this.nombresPartidos = nombresPartidos;
        this.votos = new VotosPartido(0, 0);
    ...
    */
    ...
    public SistemaCNE(String[] nombresDistritos, int[] diputadosPorDistritos,
                      int[] rangoMesasDistritosInf, int[] rangoMesasDistritosSup,
                      int[] totalVotosDist, boolean[] calcDip,
                      String[] nombresPartidos, int cantidadDeDistritos) {

        // Inicialización de distritos. 
        this.distritos = new Distrito[nombresDistritos.length]; // O(D)
        for (int i = 0; i < nombresDistritos.length; i++) {
        this.distritos[i] = new Distrito(nombresDistritos[i], diputadosPorDistritos[i],
                                     rangoMesasDistritosInf[i], rangoMesasDistritosSup[i],
                                     totalVotosDist[i], calcDip[i]); // Esta parte tiene una complejidad interna.
        ...
        this.partidos[i] = new Partido(nombresPartidos[i],); // O(1)
}
        ...
        this.mesasRegistradas = new boolean[ tamaño ];
